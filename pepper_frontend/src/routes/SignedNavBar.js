...
const SignedNavbar = () => {
    ...
    return (
        <nav className="nav w-screen border-t-0 bg-white border-gray-200 dark:bg-gray-900 fixed z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className="w-screen-xl flex items-center justify-between mb-0 pl-2 pr-4">
                <a href="/home" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <Svg_3 />
                </a>
                <div className="flex items-center space-x-8 rtl:space-x-reverse ml-auto">
                    <div className="font-bold hidden md:flex md:items-center md:space-x-8 rtl:space-x-reverse" id="navbar-user">
                        <a href="/home" className="block py-2 px-3 text-gray-900 rounded md:bg-transparent md:p-0 hover:text-[#fa1111]">Home</a>
                        <a href="/recipes" className="block py-2 px-3 text-gray-900 rounded md:bg-transparent md:p-0 hover:text-[#fa1111]">Recipes</a>
                    </div>
