    ...
    return (
        <div className="flex flex-col justify-center items-center image">
            ...
            <button className="border-2 p-2 mt-4 border-black mb-4" disabled={index !== arr.length - 1} onClick={async (e) => {
                ...
                let body_sent = { title, cardDescription, description, prepTime, cookTime, Servings, sts_process: textareas, noOfIngredients: numOfIngredients, ingredients: data, imgSrc,nutrition
                }
